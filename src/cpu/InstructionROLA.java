...
public class InstructionROLA extends InstructionHandler {

	private AddressingMode mode;
	private int length;
	private int cycles;

	public InstructionROLA(AddressingMode mode, int length, int cycles) {
		this.mode = mode;
		this.length = length;
		this.cycles = cycles;
	}
	...
	/**
	 * Rotate all bits in accumulator left. Shift all bits left. Carry is
	 * shifted into bit 0, bit 7 is shifted into carry.
	 */
	@Override
	public void execute() {
