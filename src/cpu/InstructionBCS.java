...
public class InstructionBCS extends InstructionHandler{
	private AddressingMode mode;
	private int length;
	private int cycles;

	public InstructionBCS(AddressingMode mode, int length, int cycles) {
		this.mode = mode;
		this.length = length;
		this.cycles = cycles;
	}
	 ...
	 * carry flag is set, add whatever mode.read() returns to PC.
	 */
	@Override
	public void execute() {
	...
	public String toString() {
		return "BCS instruction with " + mode;
	}
