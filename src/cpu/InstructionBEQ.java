...
public class InstructionBEQ extends InstructionHandler {
	private AddressingMode mode;
	private int length;
	private int cycles;

	public InstructionBEQ(AddressingMode mode, int length, int cycles) {
		this.mode = mode;
		this.length = length;
		this.cycles = cycles;
	}
	 ...
	 * zero flag is set, add whatever mode.read() returns to PC.
	 */
	@Override
	public void execute() {
	...
	public String toString() {
		return "BEQ instruction with " + mode;
	}
